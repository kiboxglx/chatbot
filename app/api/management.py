...
def get_qrcode():
    ...
    try:
        ...
        # Timeout aumentado para 300s (5 min) para dar tempo do Chrome abrir
        requests.post(start_url, json=payload, headers=headers, timeout=300)
        ...
        resp = requests.get(status_url, headers=headers, timeout=300)
