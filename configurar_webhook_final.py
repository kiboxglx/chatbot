...
API_KEY = "123caPtcha7"  # API Key correta do Railway
INSTANCE = "chatbot"
...
try:
    ...
    if resp.status_code == 200:
        ...
        print(f"   Nenhuma configuração encontrada ou erro: {resp.text[:100]}")
except Exception as e:
    print(f"   Info: {e}")
...
try:
    ...
    if resp.status_code in [200, 201]:
        ...
        print("   2. O bot deve responder automaticamente em segundos")
        print("   3. Experimente perguntar sobre DAS, DARF, etc.")
        print("\n💡 DICA: Se você responder manualmente, o bot pausa por 30 min")
    else:
